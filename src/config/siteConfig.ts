...
export const siteConfig: SiteConfig = {
	title: "ハナアサギのはな屋",
	subtitle: "Personal Blog based on Mizuki",
	siteURL: "https://hanaasagi-no-hanaya.pages.dev/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2026-06-10", // 站点开始运行日期，用于站点统计组件计算运行天数

	lang: SITE_LANG,

	themeColor: {
		hue: 195, // 主题色的默认色相，范围从 0 到 360。例如：红色：0，青色：200，蓝绿色：250，粉色：345
	...
	navbarTitle: {
		...
		icon: "assets/home/home-logo.png",
		// 网站Logo图片路径
	...
	bilibili: {
		vmid: "631749766", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
	...
	banner: {
		...
		homeText: {
			...
			subtitle: [
				...
				"君は君であれ 君以外の何者でもなく",
				"鳥は殻を破らねばならない 卵は世界だ",
				"ただ生きることを望む、ただ存在することを求める そして、私が望む\"私\"になる",
				"でも運の悪いことに、君のことが好きだ",
				"ペンを執り、ペンを置く ひとつの終止符を打つ",
				"雪がまぶしくて、君が懐かしくて",
			],
			typewriter: {
		...
		credit: {
			...
			text: "ひとばさん・双葉湊音公式", // 要显示的来源文本
			url: "https://www.futabaminato.com/", // （可选）原始艺术品或艺术家页面的 URL 链接
		},
